...
const char* pluginManagerJsData = R"(setInterval(function () {
    if (document.querySelector(".g-mn-set") && !document.querySelector("#betterncmPM")) {
        ...
        settings.innerHTML = "<h3 class='s-fc1 f-ff2' style='font-size:20px;font-weight:800;margin:20px;'>BetterNCM</h3><button class='u-ibtn5' onclick='fetch(\"http://localhost:3248/explorer\")'>打开配置文件夹</button><button class='u-ibtn5' onclick='document.location.reload()'>重载页面</button><div class='plugins'></div>"
